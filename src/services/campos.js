...
const CAMPOS = [
  ...
  { clave: 'sexo', etiqueta: 'Sexo', grupo: 'Identidad' },
  ...
  { clave: 'contrato_laboral', etiqueta: 'Contrato Laboral (Fijo/Temporal/Independiente/Otros)', grupo: 'Laboral' },
  ...
  { clave: 'estado_civil', etiqueta: 'Estado Civil', grupo: 'Beca' },
  { clave: 'vivienda', etiqueta: 'Vivienda (Propia/Rentada/Prestada)', grupo: 'Beca' },
